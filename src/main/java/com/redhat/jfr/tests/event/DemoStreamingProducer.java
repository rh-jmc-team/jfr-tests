...
public class TestStreamingRecordingStream {
    ...
    public static void run() throws Exception {
        ...
        try (var rs = new RecordingStream()) { //creates new recording too
            rs.enable("jdk.JavaMonitorEnter").withThreshold(Duration.ofMillis(10)).withStackTrace(); //dont really need to enable stacktraces
...
//                    rs.dump(Path.of("/home/rtoyonag/IdeaProjects/graal/substratevm/stream_dump_1_flush.jfr"));
            ...
            Thread.sleep(8000);
            rs.dump(Path.of("/home/rtoyonag/IdeaProjects/graal/substratevm/stream_dump_manyflush.jfr"));
            Thread.sleep(2000);
